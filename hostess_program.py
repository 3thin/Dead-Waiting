...
def hostess():
    ...
    if please_fuck_off == "I'm not staring, I'm looking.":
      functions.print_conversationally("'You're a creep.' She steps forward and slaps you. Her nails leave deep scratches in your cheek.")
