...
class Person:
    ...
    def eat_food(self, food):
      if world.main_character.health == 100:
        functions.print_conversationally("Chillax, yo! I don't think you should eat any more or else those pants you're sportin' might just blow wide open.")
      elif food.nutrition + world.main_character.health >= 100:
        functions.print_conversationally("Chillax, yo! I don't think you should eat any more or else those pants your sportin' might just blow wide open.")  
      else:
    ...
    def gain_charisma(self, affability):
      ...
      functions.print_conversationally(colored(f"\n\nHeck yeah! You're smooth as hell! + {affability} charisma.\n\n", "green"))
      functions.print_conversationally(colored("Charisma: ", "green"))
      functions.print_conversationally(f"{self.charisma}")
