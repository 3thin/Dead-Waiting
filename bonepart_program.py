...
def bonepart():
    ...
    what_do_you_want = functions.menu("\n\nWhat do you want?", ["Nothing, stop asking, go away.", "I just want to know what's going on!", "Less crippling anxiety.", "Your pants."])
    ...
    elif what_do_you_want == "I just want to know what's going on!":
      functions.print_conversationally("'Wittle baby wants to know what's going on? Wittle baby's confused about the unpredicatable and at times irrational nature of their world? Wittle baby's scared? Well, don't worry wittle baby. You're about to be fired, THAT'S what's happening.'\n\nThe man laughs at the look on your face.")
    ...
    functions.print_conversationally("\n\n'Okay, enough playing around. For real, who are you?'")

    user_name = functions.get_user_input("\n\nEnter your name:").capitalize()

    functions.print_conversationally(
    f"'Right, right, right. {user_name}. You're new? Jeez, you're old to be working this job. How old are you?'"
      )
    ...
    functions.print_conversationally(
    f"'Really? You look terrible. I thought you were at least... I dunno... {joke_age}?'\n\n'Anyways, {world.main_character.name}, if you don't get your ass out of this locker and start working, then I'm going to destroy you. Now go!'"
      )
    ...
    if one_last_thing == "Wait, who are you?":
      functions.print_conversationally("'You seriously don't know? The name's Bonepart. I'm your chef.'")
    elif one_last_thing == "Wait, what should I do?":
      functions.print_conversationally(f"Seriously,  {world.main_character.name}? You need me to do your job for you? Go light the candles. Let me know when you're done.'")
    elif one_last_thing == "I don't like the way you're talking to me.":
      functions.print_conversationally("'I don't care. I'm Chef Bonepart. Do your job or find a new one.'")
    elif one_last_thing == "Yes sir, right away sir, absolutely sir!":
      functions.print_conversationally("'You're a smart alec, you know that?'")
