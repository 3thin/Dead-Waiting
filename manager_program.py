...
def manager():
    ...
    world.manager.name = "Russell"
    world.manager.side_character_enter_room(world.kitchen)
    world.bonepart_intro = 2

    functions.print_conversationally("The large, bald man looks up from his clipboard and stares at you, his eyes black pits of ignorance. 'Waddaya want?' Now you remember. This is your manager: Russell. You also remember that the man is a complete and total bully.")
    ...
    if waddaya_want == "Nothing, just passing through.":
      ...
      functions.print_conversationally(f"'Truth, man! It's a messed up world out there. We could all stand to gain a little compassion.' This surprises you, as typically {world.manager.name} is a bit of a jerk. But hey, I guess people can surprise you.\n\nYou turn to leave but he stops you by putting a hand on your shoulder. 'Don't forget your notepad, kid.'")
      objects.notepad()
      world.manager_level = 2
