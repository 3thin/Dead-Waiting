...
class Game:
    ...
    def print_introductory_message(self):
        ...
        "Hey dork. Welcome to the game. Now, you might be wondering how to play and that is perfectly natural albeit incredibly stupid. Just use your intuition, okay wittle baby? Or type HELP for help..."
          ""
        )
        ...
        while (True):
            ...
            if user_input == "HELP":
              ...
              if bonepart_intro != 1:
                ...
                if mood_set == 0:
                  functions.print_conversationally("'The hell are you still doing here? Go light the candles.'")
                elif mood_set == 1:
                ...
                if joanne_mood == 0:
                  functions.print_conversationally("'Back off.'")
                elif joanne_mood == 1:
            ...
            elif main_character.current_room == manager.current_room and "MANAGER" in user_input or "RUSSELL" in user_input and manager_level == 2:
              ...
              functions.print_conversationally(f"Seriously? You want another knife? Psycho...")
              ...
              if "COW" in user_input:
                ...
                if eat_what in main_character.foods:
                  if eat_what.cooked == True:
                    ...
                    functions.print_conversationally("blech! That's raw fool!")
                else:
                  pass
